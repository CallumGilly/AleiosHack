...
query = 'INSERT INTO Hack.analysis (avglongitude,avglatitude,groupid,frequency,category,trend,Rank) VALUES ({},{},{},{},{},{},{})'
...
for i in range(0,len(groupeddf.index)):
    ...
    db_cursor.execute(query.format(longitude,latitude,groupid,frequency,category,trend,rank))
